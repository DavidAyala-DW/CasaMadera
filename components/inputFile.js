export default function File({ className }) {
  return (
    ...
    >
      <p
        className={`block opacity-80 text-base md:text-[20px] vw:text-[1.0416vw] leading-[1.5] font-light`}
      >
        Upload Attachment
      </p>
      ...
      <label
        htmlFor="file"
        className="outline-none bg-transparent border-[.5px] border-[#4A3419]
