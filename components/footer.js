          ...
          <div className="hidden md2:flex items-center space-x-[20px] vw:space-x-[2.1875vw]">
            {privacyPolicyHandle && (
              <Link href={privacyPolicyHandle?.link?.url} passHref>
                <a
                  className={`text-base vw:text-[.9375vw] leading-[25px] vw:leading-[1.3888] tracking-[-.04em] font-light`}
                >
        ...
        <div className="flex flex-col space-y-16 md2:space-y-[110px] vw:space-y-[5.729vw] justify-between w-full 3xl:w-[26.927vw]">
          <div className="flex flex-col space-y-6 md2:space-y-8 vw:space-y-[1.666vw]">
            ...
            <form
              ...
              className="w-full md:max-w-[70%] md2:max-w-full"
            >
          ...
          <div className="flex flex-col space-y-12 md2:space-y-0 md2:flex-row md2:flex-wrap md2:gap-5 md2:items-center justify-between">
            ...
            <div className="flex md2:hidden items-center space-x-[15px] vw:space-x-[1.822vw]">
              {privacyPolicyHandle && (
                <Link href={privacyPolicyHandle?.link?.url} passHref>
                  <a
                    className={`text-sm vw:text-[.9375vw] leading-[25px] vw:leading-[1.3888] tracking-[-.04em] font-light`}
                  >
                    {privacyPolicyHandle?.title}
                  </a>
                </Link>
