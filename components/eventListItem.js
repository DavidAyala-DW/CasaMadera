    ...
    <div className="px-4 md:px-6 lg:px-0 lg:max-w-[94.4%] 3xl:max-w-[95.833%] w-full mx-auto flex flex-col lg:flex-row space-y-10">
      ...
      <div className="w-full order-2 lg:w-[51.471%] 3xl:w-[50.761%] flex flex-col  lg:order-2 lg:pl-[9.86%] 3xl:pl-[10.86%]">
        ...
        <a
          ...
          className="mt-10 w-fit font-avenir text-base vw:text-[.85vw] tracking-[.05em] opacity-80 uppercase text-primary transition-colors hover:bg-primary hover:text-white font-light py-2 px-4 border border-primary"
        >
          {book_button_text}
        </a>
      </div>
