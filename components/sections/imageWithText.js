  ...
  return (
    ...
    >
      ...
      <div
        ...
        `}
      >
        <h2 className="font-light capitalize text-[32px] vw:text-[1.666vw] leading-[44px] vw:leading-[1.375] mb-6 vw:mb-[1.25vw]">
          {title}
        </h2>
        ...
        {links && (
          <SanityLink
            ...
            className={`
                ${
                  !isReservation
                    ? 'mt-10 text-lg vw:text-[.9375vw] leading-[25px] vw:leading-[1.38888] tracking-[.05em] opacity-80 uppercase underline font-light vw:mt-[2.08333vw]'
                    : ''
                }
                ${
                  isReservation
                    ? 'mt-10 text-base vw:text-[.85vw] tracking-[.05em] opacity-80 uppercase text-primary transition-colors hover:bg-primary hover:text-white font-light py-2 px-4 border border-primary max-w-max'
                    : ''
                }
              `}
          >
            ...
            {[...locations].reverse().map((location, i) => {
              ...
              return (
                <div key={_id}>
                  {!comming_soon && (
                    <Link
                      href={`/menus/${current}?menu=cocktail-menu`}
                      passHref
                    >
                      <a
