...
export default function Newsletter(props) {
  ...
  const { title, titleSize, description, descriptionSize, placeholder, is_h1 } =
    props
  ...
  const descriptionOptions = {
    normal:
      'text-base leading-[1.5] font-normal md:max-w-[551px] vw:max-w-[28.69vw] mb-10 vw:mb-[2.08333vw]',
    large:
      'text-base leading-[1.5] font-normal md:max-w-[500px] lg:max-w-[568px] vw:max-w-[29.5833vw] mb-10 vw:mb-[2.08333vw]',
  }
  ...
  return (
    <section className="px-4 md:px-0 md:max-w-[94.4%] w-full mx-auto flex flex-col text-[#4A3419]">
      ...
      <p
        ...
        ${
          descriptionSize
            ? descriptionOptions[descriptionSize]
            : descriptionOptions['normal']
        }`}
      >
        {description}
      </p>
